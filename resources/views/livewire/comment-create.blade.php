<div>
    <div x-data="{
        ...
        <div class="mb-2">
            <textarea x-ref="input" wire:model="comment" @click="focused = true" placeholder="Leave a comment" :rows="focused ? '3' : '1'"
        ...
        <div :class="isEdit || focused ? '' : 'hidden'">
            ...
            <button @click="focused = false; isEdit = false; $wire.emitUp('cancelEditing')" type="button" class="">Cancel</button>
