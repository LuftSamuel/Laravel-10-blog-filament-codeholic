            ...
            <div
                ...
                <div>
                    ...
                    @foreach ($categorias as $categoria)
                        <a href="{{ route('por-categoria', $categoria) }}"
                            class="hover:bg-blue-600 hover:text-white rounded py-2 px-4 mx-2">{{ $categoria->titulo }}</a>
                    @endforeach
                    <a href="{{ route('acerca') }}"
                ...
                <form method="get" action="{{route('search')}}">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}"
                            class="bg-blue-600 text-white rounded py-2 px-4 mx-2">Registrarse</a>
                    @endauth
                </div>
